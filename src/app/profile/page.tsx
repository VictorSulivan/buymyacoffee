...
export default async function ProfilePage(){
    ...
    return(
        <div className="max-w-2xl mx-auto px-4 mt-4">
            ...
            <div className="bg-yellow-300/30 border-2 border-yellow-300  p-4 rounded-xl flex items-center gap-2 my-4 justify-between">
                <div className="flex items-center gap-2">
                    Total money received: <span className="text-2xl">${total}</span>
                </div>
                <a 
                    href="mailto:matheoprofessionnel12@gmail.com" 
                    className="bg-yellow-300 px-4 py-2 rounded-lg flex items-center gap-1 items-center"
                >
                    Request a pay out
